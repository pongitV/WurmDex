    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    _packResult!.godPackTheme ?? strings.godPackDetected,
                    style: const TextStyle(
                      color: Colors.black,
                      fontSize: 13,
                      fontWeight: FontWeight.w900,
          ...
          // Cards Grid
          Text(
            '${strings.isEn ? 'Pulled Cards' : 'Cartas Obtidas'} (${_packResult!.cards.length})',
            style: const TextStyle(
              color: Colors.white,
              fontSize: 16,
              fontWeight: FontWeight.bold,
          ...
          GridView.builder(
            ...
            itemCount: _packResult!.cards.length,
            itemBuilder: (context, index) {
              final pull = _packResult!.cards[index];
              final card = pull.card;
              final price = card.effectiveMidPriceUsd ?? card.tcgMarketUsd;
