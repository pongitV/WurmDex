...
class VirtualBinderViewState extends ConsumerState<VirtualBinderView>
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: _buildMarkerStickerTape(widget.folderName ?? 'WURMDEX'),
                ),
              ...
              itemBuilder: (context, slotIndex) {
                if (slotIndex < pageCards.length) {
                  ...
                  return CardShimmerGlow(
                    isGlowing: isGlowing,
                    child: _buildCardPocket(context, card),
                  );
                } else {
                  return _buildEmptyPocket(context);
                }
              },
            ),
          ),
  ...
  Widget _buildCardPocket(BuildContext context, UserCard card) {
    final currency = ref.watch(currencyProvider);
    final exchangeRate = ref.watch(exchangeRateProvider);
      ...
      child: InkWell(
        onTap: () {
          final item = PokemonCardItem(
            ...
            rarity: card.rarity.isNotEmpty ? card.rarity : _strings.defaultRarity,
        ...
        onLongPress: () => _showPocketContextMenu(context, card),
              ...
              child: Stack(
                ...
                children: [
                  PokemonCardImage(
                    ...
                    // Condition / Quality & Price bottom overlay pill (compact at bottom-right, leaves card number, rarity & art 100% visible)
                    Positioned(
                      bottom: 2,
                      right: 2,
                      child: Container(
  ...
  void _showPocketContextMenu(BuildContext context, UserCard card) {
    final theme = Theme.of(context);
    final title = SemanticSearchHelper.formatCardIdentifier(
      rawName: card.name,
      number: card.number,
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: Text(_strings.viewQuoteAndHistory),
                onTap: () {
                  Navigator.pop(ctx);
              ...
              ListTile(
                ...
                title: Text(_strings.openInLiga),
                onTap: () {
                  Navigator.pop(ctx);
              ...
              ListTile(
                ...
                title: Text(_strings.openInTcgPlayer),
                onTap: () {
                  Navigator.pop(ctx);
              ...
              ListTile(
                ...
                title: Text(_strings.deleteFromCollection, style: const TextStyle(color: AppColors.lossRed, fontWeight: FontWeight.bold)),
                onTap: () {
                  Navigator.pop(ctx);
  ...
  Future<void> _confirmDeleteCard(UserCard card) async {
    final confirm = await showDialog<bool>(
      context: context,
      builder: (ctx) => AlertDialog(
        title: Text(_strings.confirmDeleteCardTitle),
        content: Text(_strings.confirmRemoveFromFolderMsg(card.name, card.number)),
        actions: [
          TextButton(
    ...
    if (confirm == true && mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(_strings.cardRemovedFromCollection(card.name))),
      );
    }
  }

  Widget _buildEmptyPocket(BuildContext context) {
    final theme = Theme.of(context);
    return InkWell(
  ...
  Widget _buildMarkerStickerTape(String name) {
    ...
    return Transform.rotate(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          // Warm paper masking tape / adhesive label finish
          gradient: const LinearGradient(
          ...
          boxShadow: [
            // Soft realistic tape drop shadow onto the binder folio leather
            BoxShadow(
            ...
            // Subtle top rim paper highlight
            BoxShadow(
        ...
        child: IntrinsicWidth(
          child: Row(
            ...
            children: [
              ...
              // Felt-tip marker handwriting (canetinha)
              Flexible(
                child: Text(
                  displayName,
                  style: const TextStyle(
...
/// CustomPainter that paints the front curved arch of the binder ring with realistic chrome shading.
/// The ring arches out of the page holes, curving forward in 3D and looping back through the opposing hole.
class _RingFrontArchPainter extends CustomPainter {
  @override
